...
export function getpositionleftactiveflag(activeindex){
	return {
		type:'SET_LEFT_POSITION_ACTIV_FLAG',
		payload:{
			activeleftpositionflg:activeindex
		}
	}
}
export function getpositionrightactiveflag(activeindex){
	return {
		type:'SET_RIGHT_POSITION_ACTIV_FLAG',
		payload:{
			activerightpositionflg:activeindex
		}
	}
}
